...
/* routes for DetalleVen Controller */
	...
	Route::get('detalleven/index/{filter?}/{filtervalue?}', 'DetalleVenController@index')->name('detalleven.index');

/* routes for NotPqrs Controller */
	Route::get('notpqrs', 'NotPqrsController@index')->name('notpqrs.index');
	Route::get('notpqrs/index/{filter?}/{filtervalue?}', 'NotPqrsController@index')->name('notpqrs.index');	
...
/* routes for PqrsAsig Controller */
	...
	Route::get('pqrsasig/index/{filter?}/{filtervalue?}', 'PqrsAsigController@index')->name('pqrsasig.index');	
...
/* routes for PqrsCarg Controller */
	...
	Route::get('pqrscarg/index/{filter?}/{filtervalue?}', 'PqrsCargController@index')->name('pqrscarg.index');	
...
/* routes for PqrsDpto Controller */
	...
	Route::get('pqrsdpto/index/{filter?}/{filtervalue?}', 'PqrsDptoController@index')->name('pqrsdpto.index');	
...
/* routes for PqrsEnt Controller */
	...
	Route::get('pqrsent/index/{filter?}/{filtervalue?}', 'PqrsEntController@index')->name('pqrsent.index');	
...
/* routes for PqrsMun Controller */
	...
	Route::get('pqrsmun/index/{filter?}/{filtervalue?}', 'PqrsMunController@index')->name('pqrsmun.index');	
...
/* routes for PqrsPet Controller */
	...
	Route::get('pqrspet/index/{filter?}/{filtervalue?}', 'PqrsPetController@index')->name('pqrspet.index');	
...
/* routes for PqrsRegPqrs Controller */
	...
	Route::get('pqrsregpqrs/index/{filter?}/{filtervalue?}', 'PqrsRegPqrsController@index')->name('pqrsregpqrs.index');	
...
/* routes for PqrsRespon Controller */
	...
	Route::get('pqrsrespon/index/{filter?}/{filtervalue?}', 'PqrsResponController@index')->name('pqrsrespon.index');	
...
/* routes for PqrsRespu Controller */
	...
	Route::get('pqrsrespu/index/{filter?}/{filtervalue?}', 'PqrsRespuController@index')->name('pqrsrespu.index');	
...
/* routes for PqrsTipdoc Controller */
	...
	Route::get('pqrstipdoc/index/{filter?}/{filtervalue?}', 'PqrsTipdocController@index')->name('pqrstipdoc.index');	
...
/* routes for PqrsTipent Controller */
	...
	Route::get('pqrstipent/index/{filter?}/{filtervalue?}', 'PqrsTipentController@index')->name('pqrstipent.index');	
...
/* routes for PqrsTipsol Controller */
	...
	Route::get('pqrstipsol/index/{filter?}/{filtervalue?}', 'PqrsTipsolController@index')->name('pqrstipsol.index');	
