                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="td-checkbox">
                                                            <label class="form-check-label">
                                                                <input class="toggle-check-all form-check-input"
                                                                    type="checkbox" />
                                                            </label>
                                                        </th>
                                                        <?php } ?>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class=" td-checkbox">
                                                            <label class="form-check-label">
                                                                <input class="optioncheck form-check-input"
                                                                    name="optioncheck[]" value="<?php echo $data['role_id']; ?>"
                                                                    type="checkbox" />
                                                            </label>
                                                        </td>
                                                        <?php } ?>
                                                        ...
                                                        <td class="td-masterdetailbtn">
                                                            <a data-page-id="roles-detail-page"
                                                                class="btn btn-sm btn-secondary open-master-detail-page"
                                                                href="<?php print_link("roles/masterdetail/$data[role_id]"); ?>">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item record-delete-btn"
                                                                        ...
                                                                        href="<?php print_link("roles/delete/$rec_id"); ?>">
                                                ...
                                                <tbody class="page-data">
                                                    <tr>
                                                        <td class="bg-light text-center text-muted animated bounce p-3"
                                                            colspan="1000">
                                                            <i class="material-icons">block</i> ningún registro fue
                                                            encontrado
                                                        </td>
                                                    </tr>
                                                </tbody>
