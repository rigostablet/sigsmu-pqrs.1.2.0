    ...
    <div class="master-detail-page card">
        ...
        <div class="p-2">
            ...
            <li class="nav-item">
                <a data-bs-toggle="tab" href="#user_<?php echo $page_id ?>" class="nav-link ">
                Role User
            </a>
        </li>
    </ul>
...
<div class="tab-pane fade show " id="user_<?php echo $page_id ?>" role="tabpanel">
<div class=" ">
    <?php
        $params = ['user_role_id' => $rec_id,'show_header' => false]; //new query param
        $query = array_merge(request()->query(), $params);
        $queryParams = http_build_query($query);
        $url = url("user/index/user_role_id/$rec_id?$queryParams");
    ?>
    <div class="ajax-inline-page" data-url="{{ $url }}" >
        <div class="ajax-page-load-indicator">
            <div class="text-center d-flex justify-content-center load-indicator">
