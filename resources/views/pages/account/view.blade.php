                                            ...
                                            <div class="page-data">
                                                ...
                                                <div class="mb-3 row row justify-content-start g-0">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                    <small class="text-muted">Mun</small>
                                                                    <div class="fw-bold">
                                                                        <?php echo  $data['mun'] ; ?>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                    <small class="text-muted">Photo Mun</small>
                                                                    <div class="fw-bold">
                                                                        <?php 
                                                                            Html :: page_img($data['photo_mun'], 'auto', 'auto', "", 1); 
                                                                        ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <small class="text-muted">Dpto User</small>
                                                                <div class="fw-bold">
                                                ...
                                                <div class="col-12">
                                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <small class="text-muted">Nom Ofic User</small>
                                                                <div class="fw-bold">
