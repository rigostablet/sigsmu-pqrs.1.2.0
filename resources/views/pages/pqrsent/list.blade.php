                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class=" td-checkbox">
                                            <label class="form-check-label">
                                            <input class="optioncheck form-check-input" name="optioncheck[]" value="<?php echo $data['id_ent'] ?>" type="checkbox" />
                                            </label>
                                        </td>
                                        <?php } ?>
                                        <!--PageComponentStart-->
                                        ...
                                        <td class="td-btn">
                                            ...
                                            <?php } ?>
                                            <?php if($can_delete){ ?>
                                            <a class="dropdown-item record-delete-btn" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal" href="<?php print_link("pqrsent/delete/$rec_id"); ?>" >
            ...
            <div class=" mt-3">
                <div class="row align-items-center justify-content-between">    
                    <div class="col-md-auto d-flex">    
                        ...
                        " data-display-style="modal" data-url="<?php print_link("pqrsent/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
