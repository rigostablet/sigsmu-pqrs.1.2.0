            ...
            <div class="row ">
                <div class="col comp-grid " >
                    <div  class=" page-content" >
                        <div id="pqrsregpqrs-list_pqrs_contrat-records">
                            <div id="page-main-content" class="table-responsive">
                                ...
                                <?php Html::page_bread_crumb("/pqrsregpqrs/list_pqrs_contrat", $field_name, $field_value); ?>
                                ...
                                <table class="table table-hover table-sm text-left">
                                    <thead class="table-header ">
                                        <tr>
                                            ...
                                            <th class="td-fec_sol" > fec_Sol</th>
                                            <th class="td-fecrep_sol" > fec_esp</th>
                                            <th class="td-tipsol_nombre" > Tipo_solic</th>
                                            <th class="td-nom_ent_sol" > Tipo_Ent</th>
                                            <th class="td-nom_pet_sol" > nom_pet</th>
                                            <th class="td-desc_sol" > descrip</th>
                                            <th class="email_sol" > email_petic</th>
                                            <th class="td-regsol_photo" > soporte</th>
                                            <th class="td-id_asig_sol" > asignado</th>
                                            <th class="td-regsol_dias" > dias_Asig</th>
                                            <th class="td-diaspen_sol" > dias_Pend</th>
                                            <th class="td-regsol_est" > estado</th>
                                            <th class="td-usu_sol" > Usuario</th>
                                            <th class="td-nom_ent" > Nombre_Ent</th>
                                            
                                            <th class="td-nom_mul" > mun petic</th>
                                            <th class="td-mun_user_sol" > Muni_User</th>
                                    ...
                                    <tbody class="page-data">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-regsol_photo"><?php Html :: page_img($data['regsol_photo'], '50px', '50px', "medium", 1, "$data[regsol_photo]"); ?></td>
