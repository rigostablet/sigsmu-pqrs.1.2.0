...
<?php
    ...
    $pageTitle = "listado pqrs respondidas"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Respuestas realizadas </div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="pqrsregpqrs-pqrs_respond-records">
                        <div id="page-main-content" class="table-responsive">
                            ...
                            <?php Html::page_bread_crumb("/pqrsregpqrs/pqrs_respond", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-fecrep_sol" >resp prog</th>
                                        ...
                                        <th class="td-regsol_dias" > dias asignadis</th>
                                        <th class="td-diaspen_sol" > dias pendientes</th>
                                        <th class="td-regsol_est" > estado notif</th>
                                        <th class="td-usu_sol" > usuario oficina</th>
