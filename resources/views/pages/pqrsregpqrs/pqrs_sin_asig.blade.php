...
<?php
    ...
    $pageTitle = "pqrs sin asignar"; //set dynamic page title
?>
@extends($layout)
...
<section class="page" data-page-type="list" data-page-url="{{ url()->full() }}">
    <?php
        if( $show_header == true ){
    ?>
    <div  class="bg-light p-3 mb-3 sizefonttable" >
        <div class="container-fluid">
            ...
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">pqrs sin asignar</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="pqrsregpqrs-pqrs_sin_asig-records">
                        <div class="row gutter-lg ">
                            <div class="col">
                                <div id="page-main-content" class="table-responsive">
                                    <?php Html::page_bread_crumb("/pqrsregpqrs/pqrs_sin_asig", $field_name, $field_value); ?>
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-masterdetailbtn">
                                                    <a data-page-id="pqrsregpqrs-detail-page" class="btn btn-sm btn-secondary page-modal" href="<?php print_link("pqrsregpqrs/masterdetail/$data[id_sol]"); ?>">
                                                    Asignar PQRS
                                                </a>
                                            </td>
                                            <td class="td-fec_sol">
                                            ...
                                            <td class="td-regsol_photo">
                                                <?php 
                                                    Html :: page_img($data['regsol_photo'], '50px', '50px', "large", 3); 
                                                ?>
                                            </td>
