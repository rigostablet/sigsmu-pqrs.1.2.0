...
<section class="page" data-page-type="add" data-page-url="{{ url()->full() }}">
    ...
    ?>
    <div  class="" >
        <div class="container back-table">
            <div class="row q-col-gutter-md justify-center">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="pqrsregpqrs-add_pqrs_contrat-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('pqrsregpqrs.add_pqrs_contrat_store') }}" method="post">
                            @csrf
                            <div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-3">
                                        <label class="control-label" for="mun_user_sol">mun activo <span class="text-danger">*</span></label>
                                        <div id="ctrl-mun_user_sol-holder" class=" "> 
                                            <input id="ctrl-mun_user_sol" data-field="mun_user_sol"  value="<?php echo get_value('mun_user_sol', auth()->user()->cod_mun) ?>" type="text" placeholder="Escribir mun activo"  readonly required="" name="mun_user_sol"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group col-3">
