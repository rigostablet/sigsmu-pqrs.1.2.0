<!-- 
expose component model to current view componente de modelo de datos
...
<?php
    ...
    $can_edit = $user->canAccess("pqrsent/add");
?>
@extends($layout)
                ...
                <div class="col-md-9 comp-grid" >
                    <div  class="card text-lowercase card-1 rounded page-content" >
                        ...
                        <form id="pqrsregpqrs-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('pqrsregpqrs.store') }}" method="post">
                            ...
                            <div>
                                <div class="row">
                                    <div class="text-primary form-group col-4">
                                    ...
                                    <div class="form-group col-4 text-primary">
                                        <label class="control-label" for="id_ent_sol">Nombre entidad <span class="text-danger">*</span></label>
                                        ...
                                        <!--BOTON AGREGADO PARA INGRESAR UNA ENTIDAD -->
                                        
                                            <?php $modal_id = "modal-" . random_str(); ?>
                                            <?php if($can_add){ ?>
                                                <a  class="btn btn-primary btn-block" href="<?php print_link("pqrsent/add", true) ?>"title="adicionar entidad" >
                                                    <i class="material-icons mi-xxs">add</i>  
                                                </a>    
                                            <?php } ?> 
                                    </div>
                                    ...
                                    <!--BOTON AGREGADO PARA INGRESAR UN PETICIONARIO --->
                                    <div class="form-group col-3 text-primary">
                                        <?php $modal_id = "modal-" . random_str(); ?>
                                        <?php if($can_add){ ?>
                                            <a  class="btn btn-primary btn-block" href="<?php print_link("pqrspet/add", true) ?>" title="adicionar peticionario" >
                                                <i class="material-icons mi-xxs">add</i>  
                                            </a>
                                        <?php } ?> 
                                    </div>   
                                    ...
                                    <div class="form-group col-3 text-primary">
                                        ...
                                        <div id="ctrl-medio_sol-holder" class=" "> 
                                            ...
                                            <?php
                                                ...
                                                $value = $option['value'];
                                                $label = $option['label'];
                                                $selected = Html::get_field_selected('medio_sol', $value, "");
                                            ?>
                                            <option <?php echo $selected ?> value="<?php echo $value ?>">
                                            <?php echo $label ?>
                                            </option>                                   
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-3text-primary">
                                        ...
                                        <div id="ctrl-ofic_usu_sol-holder" class=" "> 
                                            <input id="ctrl-ofic_usu_sol" data-field="ofic_usu_sol"  value="<?php echo get_value('ofic_usu_sol', auth()->user()->oficina) ?>" type="text" placeholder="Escribir oficina activa"  readonly required="" name="ofic_usu_sol"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group col-2 text-primary">
                                        ...
                                        <div id="ctrl-mun_user_sol-holder" class=" "> 
                                            <input id="ctrl-mun_user_sol" data-field="mun_user_sol"  value="<?php echo get_value('mun_user_sol', auth()->user()->cod_mun) ?>" type="text" placeholder="Escribir mun_activo"  readonly required="" name="mun_user_sol"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group col-4 text-primary">
                                        ...
                                        <div id="ctrl-mun_sol-holder" class=" "> 
                                            <input id="ctrl-mun_sol" data-field="mun_sol"  value="<?php echo get_value('mun_sol', "0") ?>" type="text" placeholder="Escribir municipio solicitante"  readonly required="" name="mun_sol"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
