...
?>
        <div class="">
                                    ...
                                    <table class="table table-hover table-sm text-left">
                                        <thead class="table-header ">
                                            <tr>
                                                ...
                                                <th class="td-rad_sol"> rad</th>
                                                <th class="td-fec_sol"> fecSol</th>
                                                <th class="td-fecrep_sol"> fecha Resp prog</th>
                                                <th class="td-fec_respu"> respuesta</th>
                                                <th class="td-nom_ent_sol"> entidad solic</th>
                                                <th class="td-nom_pet_sol"> nombre petic</th>
                                                <th class="td-medio_sol"> Medio Sol</th>
                                                <th class="td-desc_sol"> descripción</th>
                                                <th class="email_pet"> email_petic</th>
                                                <th class="td-nom_mun"> mun petic</th>
                                                <th class="td-regsol_photo"><i class="material-icons mi-sm">image</i>
                                                    soporte</th>
                                ...
                                ?>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class=" td-checkbox">
                                                    <label class="form-check-label">
                                                        <input class="optioncheck form-check-input" name="optioncheck[]"
                                                            value="<?php echo $data['id_sol']; ?>" type="checkbox" />
                                                    </label>
                                                </td>
                                                <?php } ?>
                                                <!--PageComponentStart-->
                                                ...
                                                <!-- email del campo email_pet de la tabla pqrs_pet -->
                                                ...
                                                <!-- Se oculta el campo email porque se muestra mejor el campo email del peticinario. Este campo que se oculta, se actualiza con el correo
                                                del responsable cuando se hace la notificacion por medio de un trigger.
                                        ...
                                        -->
                                                ...
                                                <td class="td-regsol_photo">
                                                    <img src="<?php echo $displayImage; ?>" alt="imagen previa"
                                                ...
                                                <td class="td-btn">
                                                    <div class="dropdown">
                                                        ...
                                                        <i class="material-icons">visibility</i> vista
                                                       -->
                                                            </a>
                                                            ...
                                                            <a class="dropdown-item record-delete-btn"
                                                                ...
                                                                data-display-style="modal" href="<?php print_link("pqrsregpqrs/delete/$rec_id"); ?>">
                                                                <i class="material-icons">delete_sweep</i> Borrar
                                                            </a>
                                                            <?php } ?>
                                                        </ul>
                                                    </div>
            ...
            ?>
                        ...
                        "
                                                data-display-style="modal" data-url="<?php print_link('pqrsregpqrs/delete/{sel_ids}'); ?>"
