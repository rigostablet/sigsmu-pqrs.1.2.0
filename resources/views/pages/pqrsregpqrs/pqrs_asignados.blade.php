...
<?php
    ...
    $pageTitle = "listado pqrsasignadas"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3 " >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">PQRS SIN RESPUESTAS</div>
                    </div>
                </div>
                <div class="col-auto  " >
                </div>
            ...
            <div class="row ">
                <div class="col comp-grid " >
                    <div  class=" page-content" >
                        <div id="pqrsregpqrs-pqrs_asignados-records">
                            <div class="row gutter-lg ">
                                <div class="col">
                                    <div id="page-main-content" class="table-responsive">
                                        ...
                                        <?php Html::page_bread_crumb("/pqrsregpqrs/pqrs_asignados", $field_name, $field_value); ?>
                                        ...
                                        <table class="table table-hover table-sm text-left">
                                            <thead class="table-header ">
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th class="td-" > </th><th class="td-rad_sol" > radicado</th>
                                                    <th class="td-fec_sol" > fecha pqrs</th>
                                                    <th class="td-fecrep_sol" > fecha resp</th>
                                                    ...
                                                    <th class="td-mun_user_sol" > mun oficina</th>
                                                    <th class="td-date_created" > Date Created</th>
                                                    <th class="td-btn">Acción</th>
                                                </tr>
                                            </thead>
                                            <?php
                                                if($total_records){
                                            ...
                                            <tbody class="page-data">
                                                ...
                                                <?php
                                                $imageSrc = 'https://sigsmu-pqrs.1.2.0.net/uploads/files/' . basename($data['regsol_photo']);
                                                $defaultImage = 'https://sigsmu-pqrs.1.2.0.net/uploads/files/default.png';
                                                $pdfPreview = 'https://sigsmu-pqrs.1.2.0.net/uploads/files/pdf-preview.png';
