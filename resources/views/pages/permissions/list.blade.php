...
?>
                                            ...
                                            <tr>
                                                ...
                                                <td class=" td-checkbox">
                                                    <label class="form-check-label">
                                                        <input class="optioncheck form-check-input" name="optioncheck[]"
                                                            value="<?php echo $data['permission_id']; ?>" type="checkbox" />
                                                    </label>
                                                </td>
                                                <?php } ?>
                                                <!--PageComponentStart-->
                                                ...
                                                <td class="td-role_id">
                                                    <a size="sm" class="btn btn-sm btn btn-secondary page-modal"
                                                        href="<?php print_link("roles/view/$data[role_id]?subpage=1"); ?>">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item record-delete-btn"
                                                                ...
                                                                data-display-style="modal" href="<?php print_link("permissions/delete/$rec_id"); ?>">
        ...
        ?>
                    ...
                    "
                                                data-display-style="modal" data-url="<?php print_link('permissions/delete/{sel_ids}'); ?>"
