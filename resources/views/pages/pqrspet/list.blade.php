...
?>
        <div class="">
                                                ...
                                                <td class=" td-checkbox">
                                                    <label class="form-check-label">
                                                        <input class="optioncheck form-check-input" name="optioncheck[]"
                                                            value="<?php echo $data['id_pet']; ?>" type="checkbox" />
                                                    </label>
                                                </td>
                                                <?php } ?>
                                                <!--PageComponentStart-->
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item record-delete-btn"
                                                                ...
                                                                data-display-style="modal" href="<?php print_link("pqrspet/delete/$rec_id"); ?>">
            ...
            ?>
                        ...
                        "
                                                data-display-style="modal" data-url="<?php print_link('pqrspet/delete/{sel_ids}'); ?>"
