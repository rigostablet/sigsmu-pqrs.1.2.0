...
<html>
	<head>
		...
		<meta name="author" content="orlando ripoll" />
		<meta name="keyword" content="" />
		<meta name="description" content="Aplicacion gestor pqrs alcaldias municipales" />
		<meta name="csrf-token" content="{{ csrf_token() }}">
		<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		<link rel="stylesheet" href="{{ asset('css/material-icons.css') }}" />
		<link rel="stylesheet" href="{{ asset('css/animate.css') }}" />
		<link rel="stylesheet" href="{{ asset('css/blueimp-gallery.css') }}" />
<link rel="stylesheet" href="{{ asset('css/bootstrap-theme-celurean.css') }}" />
			...
			<div id="main-content">
				...
				<template id="saving-indicator">
					<div class="p-2 text-center m-2 text-muted">
						...
						<h4 class="p-3 mt-2 font-weight-light">Enviando notificación...</h4>
					</div>
				</template>
