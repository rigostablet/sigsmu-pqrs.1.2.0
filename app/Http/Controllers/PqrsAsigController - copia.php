...
class PqrsAsigController extends Controller
{
	...
	function edit(PqrsAsigEditRequest $request, $rec_id = null){
		...
		if ($request->isMethod('post')) {
			...
			return $this->redirect("pqrsasig", "pqrs notificado con éxito!!!");
		}
    ...
    function afterEdit($rec_id,$record){
        ...
        Mail::to($correo)->send(new Mailpqrs($correo,$photoreg,$respo,$radicado,$noment,$fecresp,$nompet,$diaspen,$fecsol)); // se ejecuta el envio del email con el controlador Mailpqrs 
    }
