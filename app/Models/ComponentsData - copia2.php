...
class ComponentsData{
	...
	function mun_option_list($value = null){
		$lookup_value = request()->lookup ?? $value;
		$sqltext = "SELECT  DISTINCT cod_mun AS value,nom_mun AS label FROM pqrs_dpto WHERE cod_dpto_pqrs=:lookup_dpto_user" ;
		$query_params = [];
	...
	/**
     * nom_ofic_user_option_list Model Action
     * @return array
     */
	function nom_ofic_user_option_list(){
		$sqltext = "SELECT  DISTINCT nom_ent AS value,nom_ent AS label FROM pqrs_ent";
		$query_params = [];
		$arr = DB::select($sqltext, $query_params);
		return $arr;
	}
	...
	function getcount_sinnotificar(){
		$sqltext = "SELECT COUNT(*) AS num FROM pqrs_reg_pqrs where regsol_est = 'SIN ASIGNAR' and  ofic_usu_sol = $query_params" ;
		$query_params = [];
	...
	function getcount_sinresponder(){
		$sqltext = "SELECT COUNT(*) AS num FROM pqrs_reg_pqrs where regsol_est = 'ASIGNADO'";
		$query_params = [];
		$val = DB::selectOne($sqltext, $query_params);
		return $val->num;
	}
	...
	function getcount_respuestas(){
		$sqltext = "SELECT COUNT(*) AS num FROM pqrs_reg_pqrs where regsol_est = 'RESUELTA'";
		$query_params = [];
		$val = DB::selectOne($sqltext, $query_params);
		return $val->num;
	}
	...
	function getcount_totalpqrs(){
		$sqltext = "SELECT COUNT(*) AS num FROM pqrs_reg_pqrs";
		$query_params = [];
		$val = DB::selectOne($sqltext, $query_params);
		return $val->num;
	}
